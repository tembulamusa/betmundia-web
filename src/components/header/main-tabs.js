...
const MainTabs = (props) => {
    ...
    return (
        <div className='light-bg-secondary mb-1 block relative' style={{ zIndex: 1 }}>
                    ...
                    <>
                        ...
                        >
                            <img
                                ...
                                alt=''
                                className='main-tabs-submenu-flag'
                            />
                            <span className='top-competitions-title'>{competition?.competition_name}</span>
                        </Link>
                    </>
                ))}
            </div>
